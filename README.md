...
Exploratory Data Analysis (EDA) was performed using correlation heatmaps, histograms, box plots, bar charts, pair plots, and cluster scatter visualizations to better understand feature distributions and relationships.
Each cluster represents a distinct user persona with shared behavioral and demographic patterns, enabling clearer interpretation of customer behavior.

This approach is highly beneficial for modern businesses as it supports personalized marketing campaigns, better product recommendations, improved customer retention strategies, and efficient resource allocation.
By identifying meaningful user segments, organizations can make data-driven decisions and improve customer engagement.
The project also includes an interactive Streamlit web application that makes the model easy to use without requiring deep technical knowledge.

Users can upload their own customer datasets, view preprocessing summaries, generate clusters instantly, and explore interactive visualizations directly in the browser.
